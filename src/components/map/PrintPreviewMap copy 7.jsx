...
const PrintPreviewMap = forwardRef(
  (
    ...
    // In PrintPreviewMap.jsx, update the mapSettings to use explicit dimensions
    const mapSettings = useMemo(
      () => ({
        ...
        dragging: false, // Disable for print
        keyboard: false,
        scrollWheelZoom: false,
        touchZoom: false,
        // Add these to ensure proper rendering
        preferCanvas: false, // Force SVG renderer
        renderer: L.svg(), // Explicit SVG renderer
        // Prevent map from initializing with wrong size
        whenCreated: (map) => {
          setTimeout(() => {
            map.invalidateSize();
          }, 100);
