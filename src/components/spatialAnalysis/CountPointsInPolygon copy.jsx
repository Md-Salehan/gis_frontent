...
function CountPointsInPolygon() {
  ...
  return (
    <Space direction="vertical" style={{ width: "350px" }} size="middle">
      {/* Input Section */}
      <Card
        size="small"
        type="inner"
          ...
          <Form.Item
            ...
            help={
              validationErrors.some(
                ...
                <Text type="secondary" style={{ fontSize: 12 }}>
                  e.g., NUMPOINTS, SCHOOL_COUNT, TOTAL_POI
                </Text>
              )
            }
          >
            <Input
              ...
              placeholder="Enter count field name (e.g., NUMPOINTS)"
      ...
      <Card size="small" type="inner">
        <Flex gap="small" wrap>
          <Button
            ...
            style={{ flex: 1 }}
          >
            {isProcessing ? "Processing..." : "Count Points"}
          </Button>
          <Button
            danger
            icon={<DeleteOutlined />}
      ...
      {resultStatistics && (
          ...
          title={
            <Space size={4}>
              ...
              <Tag color="green" style={{ fontSize: 11, margin: 0 }}>
                {resultStatistics.totalPoints} points
              </Tag>
            </Space>
          }
        ...
        >
          <Row gutter={[4, 4]}>
            <Col span={8}>
              <Statistic
                title={<Text style={{ fontSize: 11 }}>Polygons</Text>}
                value={resultStatistics.totalPolygons}
                valueStyle={{ fontSize: 16 }}
                prefix={<DatabaseOutlined style={{ fontSize: 13 }} />}
              />
            </Col>
            <Col span={8}>
              <Statistic
                title={<Text style={{ fontSize: 11 }}>With Points</Text>}
            ...
            <Col span={8}>
              <Statistic
                title={<Text style={{ fontSize: 11 }}>Without</Text>}
            ...
            <Col span={8}>
              <Statistic
                title={<Text style={{ fontSize: 11 }}>Min</Text>}
            ...
            <Col span={8}>
              <Statistic
                title={<Text style={{ fontSize: 11 }}>Max</Text>}
            ...
            <Col span={8}>
              <Statistic
                title={<Text style={{ fontSize: 11 }}>Average</Text>}
