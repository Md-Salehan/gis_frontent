    ...
    async (
      ...
      for (let i = 0; i < totalSources; i++) {
        ...
        for (const idx of nearestIndices) {
          ...
          // Get target feature and its coordinates
          const targetFeature = targetFeatures[idx];
          ...
          const targetId = targetFeature.properties?.[targetIdKey] || idx;
