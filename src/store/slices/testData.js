...
export const testData = {
  ...
  schools: {
    ...
    metaData: {
      layer: {
        layer_nm: "Join of Schools with Districts",
        original_layer: "schools",
        original_layer_nm: "Schools",
  ...
  districts: {
    ...
    metaData: {
      layer: {
        layer_nm: "Districts",
        original_layer: "districts",
        original_layer_nm: "Districts",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
        geom_typ: "G" // Polygon layer
      }
    }
  },
  ...
  houses: {
    ...
    metaData: {
      layer: {
        layer_nm: "Houses",
        original_layer: "houses",
        original_layer_nm: "Houses",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  hospitals: {
    ...
    metaData: {
      layer: {
        layer_nm: "Hospitals",
        original_layer: "hospitals",
        original_layer_nm: "Hospitals",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  roads: {
    ...
    metaData: {
      layer: {
        layer_nm: "Roads",
        original_layer: "roads",
        original_layer_nm: "Roads",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
        geom_typ: "L" // Line layer
      }
    }
  },

  rivers: {
    layerId: "rivers_layer",
    geoJsonData: {
      type: "FeatureCollection",
      features: [
        {
    ...
    metaData: {
      layer: {
        layer_nm: "Rivers",
        original_layer: "rivers",
        original_layer_nm: "Rivers",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  land_parcels: {
    ...
    metaData: {
      layer: {
        layer_nm: "Land Parcels",
        original_layer: "land_parcels",
        original_layer_nm: "Land Parcels",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  police_stations: {
    ...
    metaData: {
      layer: {
        layer_nm: "Police Stations",
        original_layer: "police_stations",
        original_layer_nm: "Police Stations",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  city_wards: {
    ...
    metaData: {
      layer: {
        layer_nm: "City Wards",
        original_layer: "city_wards",
        original_layer_nm: "City Wards",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  pipelines: {
    ...
    metaData: {
      layer: {
        layer_nm: "Pipelines",
        original_layer: "pipelines",
        original_layer_nm: "Pipelines",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
  ...
  conservation_areas: {
    layerId: "conservation_areas_layer",
    geoJsonData: {
      type: "FeatureCollection",
      features: [
        {
    ...
    metaData: {
      layer: {
        layer_nm: "Conservation Areas",
        original_layer: "conservation_areas",
        original_layer_nm: "Conservation Areas",
        created: new Date().toISOString(),
        type: "centroid_result"
      },
      style: {
